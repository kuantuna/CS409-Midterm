...
template<typename ... T>                                                                     struct TransformTypes;
template<template<typename...> typename T, typename ... U, typename V>                       struct TransformTypes<T<U...>, V>
{ using type = tuple<typename T<V>::type>; };
template<template<typename...> typename T, typename ... U, typename First, typename ...Rest> struct TransformTypes<T<U...>, First, Rest...>
{ using type = concat_t<tuple<typename T<First>::type>, typename TransformTypes<T<U...>, Rest...>::type>; };

template<typename ... T>                                              struct HelperTransform;
template<typename T, template<typename...> typename U, typename ...V> struct HelperTransform<T, U<V...>>
{ using type = typename TransformTypes<T, V...>::type; };
