...
template<typename ... Ts>                  struct Concat<tuple<Ts...>, tuple<void>>  { using type = tuple<Ts...>; }; // bura eklendi
template<typename ... Ts>                  struct Concat<void, tuple<Ts...>>         { using type = tuple<Ts...>; };
template<typename ... Ts>                  struct Concat<tuple<void>, tuple<Ts...>>  { using type = tuple<Ts...>; }; // bura eklendi
